...
export const MOCK_ITINERARY: ItineraryStop[] = [
  {
    ...
    tip: 'Enter from the East Gopuram gate. Remove footwear at the entrance. Stand inside the courtyard by 7:30 AM to see the morning puja — the granite shadow of the vimana never falls outside the temple walls at any time of day.',
  ...
  {
    stop: 'Thanjavur Maratha Palace & Royal Museum',
    time: '9:30 AM',
    trafficNote: 'Light — museum opens at 9 AM',
    tip: 'Start with the Durbar Hall on the ground floor — the Maratha-era portraits and weapons collection is unmatched. Climb to the top of the Bell Tower for a panoramic view of the Big Temple and the city. Allow 90 minutes minimum.',
    currentTraffic: 'Light',
    yesterdayTraffic: 'Light',
  ...
  },
  {
    ...
    time: '11:00 AM',
    trafficNote: 'Light',
    tip: 'One of Asia\'s oldest libraries — over 60,000 palm leaf and paper manuscripts. The display gallery has rare illustrated manuscripts on paper, palm leaf, and cloth. Photography not allowed inside, but the building exterior is stunning. Takes 45–60 minutes.',
    currentTraffic: 'Light',
    yesterdayTraffic: 'Light',
  ...
  {
    stop: 'Thanjavur Thali Lunch (Sathars or Sri Venkatramana Bhavan)',
    time: '12:15 PM',
    trafficNote: 'Moderate near market area',
    tip: 'Sri Venkatramana Bhavan (0.4 km from palace) is the best banana-leaf thali in town — arrive before 12:30 PM before they run out of kuzhambu. Sathars on South Main Street is the local favourite for biryani if you prefer non-veg.',
  ...
  {
    stop: 'Thanjavur Art Gallery (Bronze Sculptures)',
    time: '1:45 PM',
    trafficNote: 'Light — afternoons are quieter',
    tip: 'Home to one of the finest collections of Chola-era bronze Nataraja sculptures in India. The 9th–12th century bronzes in Gallery 3 are extraordinary. Combined ticket with Palace Museum covers entry. Spend at least 60 minutes.',
    currentTraffic: 'Light',
    yesterdayTraffic: 'Light',
    travelToNext: '15 min · Auto',
    departBy: '3:15 PM',
  },
  {
    stop: 'Goldsmith Street — Thanjavur Paintings & Crafts',
    time: '3:30 PM',
    trafficNote: 'Moderate',
    tip: 'The original Thanjavur painting ateliers are on Goldsmith Street (Thalavaiyal Salai). Watch artisans apply real gold foil and semi-precious stones to gesso. Prices are fixed at reputed workshops — avoid touts near the temple entrance. Budget ₹800–2,000 for a small piece.',
    currentTraffic: 'Moderate',
    yesterdayTraffic: 'Light',
  ...
  {
    stop: 'Big Temple Evening Darshan & Sivaganga Park',
    time: '5:30 PM',
    trafficNote: 'Moderate — evening crowd builds after 6 PM',
    tip: 'Return to Brihadeeswarar for the evening — the temple lit up at dusk looks completely different to the morning visit. The Sivaganga Tank reflection of the vimana tower at golden hour is the best photograph of the day. Evening puja is at 6:00 PM.',
    currentTraffic: 'Moderate',
    yesterdayTraffic: 'Moderate',
  },
];
