...
export default function ProviderAadhaar() {
    ...
    <View className="flex-1 bg-white">
      ...
      <View className="flex-1 px-4 pt-6">
        ...
        <Text className="text-sm text-text-secondary mb-8">
          We have sent you a 6 digit verification code on registered{' '}
          <Text className="font-semibold text-text-primary">*******7342</Text>
        </Text>
        ...
        <View className="flex-row justify-center mb-8" style={{ gap: 10 }}>
          {otp.map((digit, i) => (
            <TextInput
              ...
              style={{ width: 46, height: 58, textAlign: 'center', fontSize: 20, fontWeight: '700', color: '#1A1A1A', borderWidth: 1, borderColor: '#e7bdb2', borderRadius: 8, backgroundColor: '#fff' }}
      ...
      <View className="px-4 pb-8">
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          <Text className="text-white text-sm font-bold">Verify & Continue</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
